...
from tools.oa.book_to_skill_setup import find_book_to_skill
from tools.oa.playbook import ingest_distilled_skill, peek_source, reject_if_url, safe_slug
from tools.oa.vault_layout import list_history_case_paths, list_playbook_index_paths, write_oa_index
...
class BookToSkillDetectTests(unittest.TestCase):
    def test_find_from_env_dir(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            import tools.oa.book_to_skill_setup as setup
