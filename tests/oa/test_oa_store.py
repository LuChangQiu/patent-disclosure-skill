...
class ConfigTests(unittest.TestCase):
    def test_recommend_and_set(self):
        from tools.oa.config import documents_dir, oa_home, default_sqlite_path
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            from tools.oa.config import skip_vector, check_rebuild_needed, apply_preset
...
class EmbedderVendorTests(unittest.TestCase):
    def test_openai_compatible_sends_dimensions(self):
        ...
        import tools.oa.embed as embed_mod
...
class SecretsAndSelftestTests(unittest.TestCase):
    def test_write_secrets_and_resolve(self):
        from tools.oa.config import write_secrets, load_secrets, resolve_api_key
    ...
    def test_selftest_skipped_when_disabled(self):
        from tools.oa.config import skip_vector, run_selftest
